...
CFLAGS=-std=c++1y -O3 -g -fopenmp -I. -I../../src/midifile-head/include `pkg-config dinrhiw --cflags` -Ifluidsynth-headers
CXXFLAGS=$(CFLAGS)
...
LIBS=-L../../src/midifile-head/lib/ -lmidifile `pkg-config dinrhiw --libs` \
